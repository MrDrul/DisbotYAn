...
NoraCop_scrap.Username = 'NoraCops'# <= Name of Parsed account
...
EnigmaRobotic_scrap.Username = 'EnigmaRobotic'# <= Name of Parsed account EnigmaRobotic
...
while True:
    ...
    in_miliseconds_2_min_ago = datetime.datetime.now() - datetime.timedelta(seconds=264)
